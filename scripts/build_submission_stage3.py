...
CHAPTER_REMAP: dict[str, str] = {
    ...
    "§6.5": "§5.5",
    # 5장 절 순서 재배열 (2026-08-26 · PLAN-081) — 결과 장은 에피소드 번호가 아니라 발견의
    # 무게를 따르므로 **EP3 이 §5.1, EP1 이 §5.3** 이다. 동결본의 §6.1(EP1)·§6.3(EP3)에
    # 대한 사상을 그만큼 맞바꾼다. 이 자리를 놓치면 표 3 이 죽은 절을 가리킨다.
    "§6.4": "§5.4", "§6.3": "§5.1", "§6.2": "§5.2", "§6.1": "§5.3",
    # 7장 논의 + 8장 한계·결론 → 6장
