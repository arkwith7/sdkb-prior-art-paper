...
- 생성(UTC): 2026-07-25T15:36:08.205752+00:00
- 지지 주장: **C2 핵심증명**(선행기술 검색)의 입력 · 논문 §5–6(RQ2·RQ3·T1·T2)

## 1. 서명 (원천·산출)
| 자원 | 값 | sha256(앞16) |
|---|---:|---|
| ir_corpus_v09.parquet | 40,552 행 | `ec5ea51b626d3ff9` |
| qrel_examiner.parquet | 2,416 엣지 | `10ab67f21cc1328d` |
| graph_v0.ttl | — | `a79a8a27db593a77` |
...
## 3. 형태·기술통계
- 총 문서: **40,552**
- source 분포: g0_cited=3,034 · g0_rej=1,000 · g1=24,179 · g2=12,339
- 언어 분포(전체): en=1,189 · ja=117 · ko=39,246
- 질의(is_query): 1,000 · 심사관 정답 노드(is_examiner_positive): 2,211
- 정답 노드 언어: en=862 · ja=83 · ko=1,266
- 텍스트 커버리지: 초록=99.8% · 청구항전체=97.9% · text_main=99.8%
- 청구항 보유 문서: 39,713 · 독립항 보유: 39,711
