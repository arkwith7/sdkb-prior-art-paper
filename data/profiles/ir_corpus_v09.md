...
- 생성(UTC): 2026-08-05T12:56:10.720825+00:00
- 지지 주장: **C2 핵심증명**(선행기술 검색)의 입력 · 논문 §5–6(RQ2·RQ3·T1·T2)

## 1. 서명 (원천·산출)
| 자원 | 값 | sha256(앞16) |
|---|---:|---|
| ir_corpus_v09.parquet | 41,031 행 | `db8132c33ceeb50a` |
| qrel_examiner.parquet | 2,416 엣지 | `10ab67f21cc1328d` |
| graph_v0.ttl | — | `3e01aa38e387ced1` |
...
- 텍스트 커버리지: 초록=99.8% · 청구항전체=96.8% · text_main=99.8%
