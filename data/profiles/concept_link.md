...
- 생성(UTC): 2026-08-07T11:53:40+00:00
...
- 신규 링크: **129,922건** · 문서 41,031
- 문서당 개념(합집합): 평균 **3.760** · 중앙값 3 · 보유율 98.5%
- 개념 어휘(합집합): **199**
...
|---|---:|---:|---:|---:|
| en | 1,412 | 4,400 | 3.116 | 3.177 |
| ja | 140 | 0 | 0.000 | 0.000 |
| ko | 39,479 | 102,001 | 2.584 | 3.794 |
...
| 축 | 링크 | 비율 |
|---|---:|---:|
| Material | 56,344 | 43.4% |
| Process | 49,762 | 38.3% |
| SubProcess | 10,452 | 8.0% |
| EquipmentClass | 6,636 | 5.1% |
| Device | 3,373 | 2.6% |
| Skill | 1,487 | 1.1% |
| Parameter | 572 | 0.4% |
| FailureMode | 545 | 0.4% |
...
| `particle` | 96 | failuremode:particle, process:clean |
...
| 표면형 | 문서 | 개념 |
|---|---:|---|
| `식각` | 7,384 | process:etch |
| `챔버` | 6,499 | equipment_class:process_chamber |
| `절연막` | 6,444 | material:dielectric |
| `가스` | 6,129 | material:process_gas |
| `플라즈마` | 4,420 | process:plasma_processing |
| `마스크` | 4,296 | material:photomask |
| `증착` | 4,197 | process:deposition |
| `산화물` | 3,837 | material:oxide |
| `박막` | 2,647 | process:deposition |
| `산화막` | 2,530 | material:oxide, material:sio2 |
| `질화물` | 2,468 | material:sin |
| `세정` | 2,157 | process:clean |
| `정렬` | 2,120 | subprocess:overlay_control |
| `포토` | 2,021 | process:lithography |
| `알루미늄` | 2,011 | material:aluminum |
...
| 표면형 | 매핑 | 문서 | 문제 |
|---|---|---:|---|
| `hf` | `material:hf_acid` | 1,245 | D-20(P1) 반도체 특허의 단독 Hf 는 하프늄(high-k)이다 — 불산 오링크 |
| `co` | `material:cobalt` | 979 | D-20 부수 위험: CO(일산화탄소)·Co.(회사명) 혼입 가능 |
