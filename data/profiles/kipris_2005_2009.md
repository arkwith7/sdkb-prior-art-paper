# 프로파일 — KIPRIS 삼성전자·SK하이닉스 특허 2005–2009 (PLAN-009 · S2(구 H2) 좌측절단 교정)
...
| G₀ 겹침 제외 | −104 | SIRP 거절특허로 이미 G₀ 에 있음 (S1 오염 방지) |
| **정제 후 특허** | **29,415** | **G₁ 에 병합되지 않는다** — S2 시계열 전용 (PLAN-009 §2). G₁ 과 S1 은 불변이다 |
