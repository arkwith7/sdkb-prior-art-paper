...
## 2026-08-07T20:10:30.623560+00:00 · IR 코퍼스 조립 (PLAN-017 M1)
- 명령: `make corpus` (`python -m sdkb_paper.corpus.assemble`)
- ir_corpus_v09.parquet: 41,031 행 · sha256 `55e38161ef99e7f3`
- qrel_examiner.parquet: 2,416 엣지 · sha256 `10ab67f21cc1328d`
- 원천: graph_v0/v1/v2.ttl + central_axis.oxstore(sidecar 청구항 재구성) + concept_mapping.json(적용기 링크 128,677건)
- 반영: C2 입력 · 논문 §5–6

## 2026-08-08T01:07:26.894200+00:00 · IR 코퍼스 조립 (PLAN-017 M1)
- 명령: `make corpus` (`python -m sdkb_paper.corpus.assemble`)
- ir_corpus_v09.parquet: 41,223 행 · sha256 `3a5afe224ab106c5`
- qrel_examiner.parquet: 2,416 엣지 · sha256 `10ab67f21cc1328d`
...
## 2026-08-08T11:26:34.778530+00:00 · IR 코퍼스 조립 (PLAN-017 M1)
- 명령: `make corpus` (`python -m sdkb_paper.corpus.assemble`)
- ir_corpus_v09.parquet: 41,223 행 · sha256 `83eef760ed0a8be2`
- qrel_examiner.parquet: 2,416 엣지 · sha256 `10ab67f21cc1328d`
- 원천: graph_v0/v1/v2.ttl + central_axis.oxstore(sidecar 청구항 재구성) + concept_mapping.json(적용기 링크 129,126건)
- 반영: C2 입력 · 논문 §5–6

## 2026-08-15T11:49:19.603140+00:00 · IR 코퍼스 조립 (PLAN-017 M1)
- 명령: `make corpus` (`python -m sdkb_paper.corpus.assemble`)
- ir_corpus_v09.parquet: 41,223 행 · sha256 `83eef760ed0a8be2`
- qrel_examiner.parquet: 2,416 엣지 · sha256 `10ab67f21cc1328d`
- 원천: graph_v0/v1/v2.ttl + central_axis.oxstore(sidecar 청구항 재구성) + concept_mapping.json(적용기 링크 129,126건)
...
## 2026-08-23T12:48:44.596133+00:00 · IR 코퍼스 조립 (PLAN-017 M1)
- 명령: `make corpus` (`python -m sdkb_paper.corpus.assemble`)
- ir_corpus_v09.parquet: 41,223 행 · sha256 `d856269392bdad52`
- qrel_examiner.parquet: 2,416 엣지 · sha256 `10ab67f21cc1328d`
- 원천: graph_v0/v1/v2.ttl + central_axis.oxstore(sidecar 청구항 재구성) + concept_mapping.json(적용기 링크 143,668건)
- 반영: C2 입력 · 논문 §5–6

## 2026-08-23T12:59:53.355885+00:00 · IR 코퍼스 조립 (PLAN-017 M1)
- 명령: `make corpus` (`python -m sdkb_paper.corpus.assemble`)
- ir_corpus_v09.parquet: 41,223 행 · sha256 `d856269392bdad52`
- qrel_examiner.parquet: 2,416 엣지 · sha256 `10ab67f21cc1328d`
- 원천: graph_v0/v1/v2.ttl + central_axis.oxstore(sidecar 청구항 재구성) + concept_mapping.json(적용기 링크 143,668건)
