# 정본 인덱스 (CANONICAL INDEX) — v0.5 구본 (ARCHIVED · 인용 금지)

> **⚠️ 구 패러다임 인덱스 — 역사 참조 · 인용 금지 (2026-07-26 archive).** 이 문서는 v0.5 커버리지/
> 시계열/이식성 패러다임의 정본 인덱스다. v0.9 정본 인덱스는
> [../CANONICAL-INDEX.md](../CANONICAL-INDEX.md)이며, 여기의 논문(`논문_v0.5`)·RQ1-3·H1/H2 라벨은
> 구 의미다(→ **S1/S2/S3**). **§1 서명표(105,588·924,814·490,529)만은 v0.9와 동일한 동결 사실**이며
> v0.9 인덱스가 그대로 승계한다. 그 외 서술·분류·그림 체계는 v0.9에서 재정의됐다 —
> [RECONCILIATION-v09.md](../RECONCILIATION-v09.md) §1 라벨 사전을 따른다. 이 문서는 이력으로만 보존한다.
