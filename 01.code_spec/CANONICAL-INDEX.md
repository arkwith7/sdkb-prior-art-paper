...
| **상류 환류 (C0)** | `DEFECT-LEDGER.md`(결함 D-01~**D-44**) · **살아 있는 CR 10건** — 투고 게이트 2건(**CR-015** 공개본 경계 · **CR-016** 공개 재현 경로) + 투고 후 8건(CR-001·002·003·005·006·009·**017**·**018**) · `archive/`(종료분 · 재송부 금지) · `HANDOFF-QUEUE.md`(송부 순서) | `upstream/` |
| **정합 원장(전파 추적)** | `RECONCILIATION-v09.md` (라벨 사전·SoT 델타·배치 B0–B8 완료) | `01.code_spec/` |
| **baseline 그래프 G₀** | `graph_v0.ttl` (**119,251** 트리플 · 구 115,095 · 105,713 · 105,588) — 게이트 대상 | `data/processed/` (gitignore — MANIFEST §3 이 서명) |
...
| 라벨 | v0.9 의미 | 주장 | 상태 |
|---|---|---|---|
| **C0 · 상류 환류** | 실험이 식별한 SDKB 결함 → 검증기준을 갖춘 상류 변경 요구 | 논문 밖 (제품 목적) | **상시** — D-01~D-44 등재 · 살아 있는 CR 10건 |
...
| 항목 | G₀ | G₁ | G₂ (소부장) |
|---|---:|---:|---:|
| **세대** | 상류 `0a7ff15` (현행 · 구 `39855bb`·`2839afb`) | 상류 `d578bf3` (**구**·미재조립) | 〃 |
| **트리플 (정본)** | **119,251** | **924,814** | **490,529** |
...
| 그래프 커밋(상류) | SDKB **`0a7ff15`** (구 `39855bb`·`2839afb`·`d578bf3`) | `d578bf3` 위 델타 (구) | 〃 (구) |
...
> T-Box 주석** — 공리 0 · 클래스·술어 수 불변). 세대별 실측은
...
| 주장 | 논문 | 증거 산출물 | 상태 |
|---|---|---|---|
| **C0 상류 환류** | 논문 밖 (제품 목적) | [DEFECT-LEDGER](../upstream/DEFECT-LEDGER.md) D-01~**D-44** · 살아 있는 CR **10건**(그중 투고 게이트 2건 CR-015·CR-016) · HANDOFF-QUEUE | **상시** — 진행 상태의 정본은 [STATUS.md](STATUS.md) 서두다 |
