...
| 주장 | 논문 | 증거 산출물 | 상태 |
|---|---|---|---|
| **C0 상류 환류** | 논문 밖 (제품 목적) | [DEFECT-LEDGER](../upstream/DEFECT-LEDGER.md) D-01~D-33 · CR 13건(종료 7 · 살아 있음 6) · HANDOFF-QUEUE | **상시** — **상류 대기 0 · 하류 미결 0(2026-08-08 9차)** · 막는 것 없음 · 다음은 개봉 사전등록 |
