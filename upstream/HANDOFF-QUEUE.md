...
| 2-b | [CR-008](CR-008-b-layer-prior-art-abox.md) | **D-18** | 1 완료 | **송부 가능 · 병렬 진행 가능** | **C2 재확증의 물리적 전제** — B층 도달성 0.0117. CR-001·007과 독립(어휘·매핑 무관) · A-Box 노드 추가뿐. 선결: 하류 PLAN-031 §11 봉인 이관 승인 |
