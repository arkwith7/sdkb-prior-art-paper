...
표 6의 일곱 구성(B0·B2·B3·B4·B5와 P0★·P1)뿐이다.
...
결합 신호에서 발생한다. 둘째, A7(전체 온톨로지 제거)의 +0.0534는 표 6의 P1 대 B3 차이와 동일한
수치이지만 비교 가족이 다르다. 표 6에서는 사전등록된 주 비교이므로 보정 없이 제시하고, 본 절에서는
...
**표 9. 범위 설계원리 DP5–DP6 — 등급은 §3.3의 문턱이 정한 그대로다.**
