...
| ⑧ | 전문가 관련성 판정 미수행 | 프로토콜은 동결하였으나 판정은 수행하지 않았다 (§4.4). 미수행이 남기는 취약도는 §5.4.1의 전복 문턱으로 계량하였다 | 상위 미인용 후보 표본에 대한 2인 가림 독립 판정과 κ 보고 |
...
해소의 우선순위는 셋이다. 첫째는 다국어 밀집 기준선의 추가로, ⑥과 ⑦을 함께 겨냥하며 봉인 규율을
유지한 채 검색 층에서 수행된다. 둘째는 상위 미인용 후보에 대한 2인 가림 판정으로, ⑧을 해소하고
등급형 지표의 전제를 복원한다(§4.5). 셋째는 자격 있는 델타 3–5건 또는 제2 공학 온톨로지에서의
