...
연결하는 질문(예: CQ13·14·19·21)은 **공유 코어(CQ-CORE)** 스위트로 귀속한다(§3.4 · S1-T1). 세 뷰
...
[S1-T1](../supplementary/S1-appendices-v09.md#s1-t1--역량질문-31개의-구분과-용도)에 있다.
...
통과하므로 감사 전량 31개 기준 G0는 30개이다(§3.4 · S1-T1). 교차 태스크 CQ 통과율은 저하되지 않았고
...
[S9-T2](../supplementary/S9-retrieval-evaluation-detail.md#s9-t2--탐색적-기준선과-원표본-요약)에 있다.
...
[S9-T1](../supplementary/S9-retrieval-evaluation-detail.md#s9-t1--하위집단과-절제-전량)에 있다.
...
판정과 운용 비용은 [S8-T1](../supplementary/S8-second-domain-port.md#s8-t1--릴리스-계보와-운용-비용)에 있다.
...
[S3-T1](../supplementary/S3-unexecuted-design-v09.md#s3-t1--검증-강도와-일반화-가능성의-결손-여섯)에
