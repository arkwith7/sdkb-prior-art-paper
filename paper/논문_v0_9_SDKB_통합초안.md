...
|---|---|---:|---:|---:|---:|---|---:|
| g0 | — (기준 세대) | 0.800 (4/5) | 1.000 (6/6) | 1.000 (5/5) | 1.000 (12/12) | — (기준) | — |
| graph_v1 | v2 (τ=0.05) | 1.000 (5/5) | 1.000 (6/6) | 1.000 (5/5) | 1.000 (12/12) | **승인** (하락 0) vs g0 | 0 |

**누적 waiver 0회.** 이 표는 `make cq-freeze`가 세대마다 남기는 아티팩트(`data/cq_generations/`)에서 **판정까지 포함해** 생성된다(`paper/tables/cq_generations.md`). 현재 축적된 세대는 기준 세대 g0과 병합 세대 graph_v1 둘뿐이므로 **추이라 부를 만한 이력이 아직 없다** — 세대를 만들어 표를 채우지 않는다.
