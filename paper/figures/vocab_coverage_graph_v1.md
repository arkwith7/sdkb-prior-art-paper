# 어휘 검증 커버리지 — `data/processed/graph_v1.ttl`
...
| CQ | 결과행 | 검증한 어휘 |
|---|---:|---|
| CQ01_patents_per_process_step | 26 | `Patent` · `Process` · `SubProcess` · `realizesProcess` |
| CQ02_recent_patents_by_step | 4051 | `Patent` · `filingDate` · `realizesProcess` |
| CQ03_uncovered_process_steps | 23 | `Patent` · `Process` · `SubProcess` · `realizesProcess` |
| CQ04_concept_annual_series | 720 | `Device` · `Patent` · `Process` · `SubProcess` · `concernsDevice` · `filingDate` · `realizesProcess` |
| CQ05_concept_vs_ipc_series | 14108 | `Patent` · `filingDate` · `hasIPC` |
| CQ06_concepts_without_recent_patents | 35 | `Device` · `Patent` · `Process` · `SubProcess` · `concernsDevice` · `filingDate` · `realizesProcess` |
| CQ07_device_process_crosswalk | 238 | `Patent` · `concernsDevice` · `realizesProcess` |
...
| CQ10_prior_art_candidates_by_concept | 90 | `Patent` · `filingDate` · `realizesProcess` |
...
| 술어 | 사용 | | 클래스 | 사용 |
|---|---:|---|---|---:|
| `applicationNumber` | 25179 | | `IPCSymbol` | 2924 |
| `patentOffice` | 25179 | | `Organization` | 351 |
| `publicationDate` | 24998 | | `STEEPVEDimension` | 7 |
| `abstractText` | 1000 | | `OptionType` | 5 |
| `examinationStatus` | 1000 | | `RejectionType` | 5 |
| `firstClaimText` | 1000 | | `ConstraintType` | 2 |
| `processFamily` | 1000 | | `Semiconductor` | 1 |
