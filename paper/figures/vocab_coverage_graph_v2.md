# 어휘 검증 커버리지 — `data/processed/graph_v2.ttl`
...
| CQ02_recent_patents_by_step | 374 | `Patent` · `filingDate` · `realizesProcess` |
| CQ03_uncovered_process_steps | 29 | `Patent` · `Process` · `SubProcess` · `realizesProcess` |
| CQ04_concept_annual_series | 310 | `Device` · `Patent` · `Process` · `SubProcess` · `concernsDevice` · `filingDate` · `realizesProcess` |
| CQ05_concept_vs_ipc_series | 2063 | `Patent` · `filingDate` · `hasIPC` |
...
| CQ08_applicant_process_portfolio | 317 | `Patent` · `assignedTo` · `realizesProcess` |
...
| 술어 | 사용 | | 클래스 | 사용 |
|---|---:|---|---|---:|
| `abstractText` | 1021 | | `IPCSymbol` | 828 |
| `applicationNumber` | 1021 | | `Organization` | 351 |
| `firstClaimText` | 1021 | | `STEEPVEDimension` | 7 |
| `patentOffice` | 1021 | | `OptionType` | 5 |
| `publicationDate` | 1012 | | `RejectionType` | 5 |
| `examinationStatus` | 1000 | | `ConstraintType` | 2 |
